...
class POP():
    ...
    def TSearch(self,initial_solution,stepsize, I_D_tenure, S_tenure,term_iter):
        '''
        The implementation Tabu search algorithm with short-term memory.
        '''
        # Parameters:
        best_solution = initial_solution
        best_objvalue = self.Objfun(initial_solution)
        current_solution = best_solution
        current_objvalue = best_objvalue
        print("#" * 30, "Short-term memory TS with I_D_tenure = {} S_tenure = {} StepSize = {}\nTermination if {} iter without finding improving solution".format(I_D_tenure, S_tenure,stepsize,term_iter), "#" * 30,
            ...
            while True:
                ...
                if t1_tabutime < iter:
                    ...
                    if t1_fun == 'S':
                        ...
                        self.tabu_str[t1_a]['tabu_time'][t1_fun] = iter + I_D_tenure
                    iter += 1
                    break
