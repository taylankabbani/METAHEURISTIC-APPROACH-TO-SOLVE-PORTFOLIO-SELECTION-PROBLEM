...
class GREEDY():
    ...
    '''
    def __init__ (self, ReturnSD_path, corr_path, Lambda, Capital, k,epsilon, delta, T, show=False):
    ...
    def greedy_fun(self):
        ...
        for i in range(self.T):
            ...
            S = valmap(lambda x: x/sum(S.values()), S) # Normalizing to sum up to 1
...
# test = GREEDY(ReturnSD_path= "Data/Hong_kong_31/Return&SD.txt", corr_path="Data/Hong_kong_31/correlation.txt", Lambda=0.5, Capital= 1000, k= 3, epsilon=0.1, delta=1, T=1000, show=True)
